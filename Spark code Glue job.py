...
from awsglue.dynamicframe import DynamicFrame # added
...
## @return: datasource0
## @inputs: []
predicate_pushdown = "region in ('ca','gb','us')" # added
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "db_youtube_raw", table_name = "raw_statistics", transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown) # modified
...
datasink1 = dropnullfields3.toDF().coalesce(1) # added
df_final_output = DynamicFrame.fromDF(datasink1, glueContext, "df_final_output") # added
